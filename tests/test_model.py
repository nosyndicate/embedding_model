...
from embedding_trainer.model.model import apply_rope, precompute_rope_cache
...
class TestPrecomputeRopeCache:
    ...
    def test_first_position_is_zero_angle(self):
...
class TestApplyRope:
    ...
    def test_multi_dim_broadcasting(self):
    ...
    def test_float16_norm_preservation(self):
        dim, seq_len = 32, 8
